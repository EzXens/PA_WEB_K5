...
//   // $read_select_sql = "SELECT g.* FROM gambar g WHERE g.nama_gambar LIKE '%$keyword%' AND g.id_user = $userId";

//   // // Cari gambar berdasarkan tag yang sesuai dengan kata kunci
//   // $read_select_sql .= " UNION SELECT g.* FROM gambar g
...
<head>
  ...
  <link rel="icon" href="assets/logo-P-removebg-preview.png">
  <style>
    *,
    button,
    input {
